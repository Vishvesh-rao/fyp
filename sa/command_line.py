import os
import argparse
from sa.main import analyze_directory, analyze_file
from sa.Result import Result, ResultMultiplePositions, output_result
from sa.Result import SARIF_MODE, SUMMARY_MODE
...
Analyze a single file `deleverage.cairo` and export results to a file:
 sa deleverage.cairo -o deleverage.sarif
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="sa is a static-analyzer for the Cairo programming language.",
